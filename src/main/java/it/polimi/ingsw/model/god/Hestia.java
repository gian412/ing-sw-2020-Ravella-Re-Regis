...
/**
 * Class Hestia, sub-class of the abstract class {@link it.polimi.ingsw.model.god.God}.
 * This class have the ability to build twice after moving, but the second build can't be in a perimeter cell.
 *
