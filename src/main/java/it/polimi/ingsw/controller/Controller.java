...
public class Controller implements Observer<PlayerCommand>, Runnable {
    ...
    public void update(PlayerCommand message){
        ...
        // all the exceptions are generated by the
        // (God)Class.forName(message.message).getDeclaredConstructor().newInstance());
        // that is normally very risky. in this case, it's necessary use, and all
        // kind of check are made before invoking this instruction: the checks we made ensures NONE
        // of the exceptions are raised
        // (we made tests)
