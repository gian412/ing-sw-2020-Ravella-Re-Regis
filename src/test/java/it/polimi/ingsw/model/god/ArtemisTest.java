...
public class ArtemisTest {
    ...
    public void moveWithNotCanMoveUp(){
        ...
        try {
            god.executeCommand(worker, command);
            fail("moveWithNotCanMoveUp in class ArtemisTest didn't throw an exception");
        } catch (IllegalMoveException e) {
    ...
    public void moveUpMoreThan1Floor() {
        ...
        try {
            god.executeCommand(worker, command);
            fail("moveUpMoreThan1Floor in class ArtemisTest didn't throw an exception");
        } catch (IllegalMoveException e) {
            assertEquals("worker's position must be firstCell", worker.getCurrentCell(), firstCell);
        }
    ...
    public void hasMovedSecondTime(){
        ...
        try {
            god.executeCommand(worker, command);
            fail("hasMovedSecondTime in class ArtemisTest didn't throw an exception");
        } catch (IllegalMoveException e) {
            assertEquals("worker's position must be firstCell", worker.getCurrentCell(), firstCell);
        }
