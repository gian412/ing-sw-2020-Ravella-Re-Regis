...
public class AtlasTest {
    ...
    public void moveWithNotCanMoveUp(){
        ...
        try {
            god.executeCommand(worker, command);
            fail("moveWithNotCanMoveUp in class AtlasTest didn't throw an exception");
        } catch (IllegalMoveException e) {
    ...
    public void moveUpMoreThan1Floor() {
        ...
        try {
            god.executeCommand(worker, command);
            fail("moveUpMoreThan1Floor in class AtlasTest didn't throw an exception");
        } catch (IllegalMoveException e) {
            assertEquals("worker's position must be firstCell", worker.getCurrentCell(), firstCell);
        }
    ...
    public void moveUpWhenCannotMoveUp() {
        ...
        try {
            god.executeCommand(worker, command);
            fail("moveUpWhenCannotMoveUp in class AtlasTest didn't throw an exception");
        } catch (IllegalMoveException e) {
            assertEquals("worker's position must be firstCell", worker.getCurrentCell(), firstCell);
        }
    ...
    public void hasMovedSecondTime(){
        ...
        try {
            god.executeCommand(worker, command);
            fail("hasMovedSecondTime in class AtlasTest didn't throw an exception");
        } catch (IllegalMoveException e) {
            assertEquals("worker's position must be firstCell", worker.getCurrentCell(), firstCell);
        }
    ...
    public void hasBuildBeforeHasMoved(){
        ...
        try {
            god.executeCommand(worker, command);
            fail("hasBuildBeforeHasMoved in class AtlasTest didn't throw an exception");
        } catch (IllegalMoveException e) {
    ...
    public void hasBuildDomeBeforeHasMoved(){
        ...
        try {
            god.executeCommand(worker, command);
            fail("hasBuildDomeBeforeHasMoved in class AtlasTest didn't throw an exception");
        } catch (IllegalMoveException e) {
            assertFalse("hasBuild must be false", god.hasBuild);
    ...
    public void resetAllGodVariable() {
        ...
        try {
            ...
            fail("Exception in resetAllGodVariable in class AtlasTest");
        }
    }
    ...
    public void nullCommand() {
        ...
        try {
            ...
            fail("nullCommand in class AtlasTest didn't throw an exception");
    ...
    public void outOfSwitchCommandType() {
        ...
        try {
            god.executeCommand(worker, command);
            fail("outOfSwitchCommandType in class AtlasTest didn't throw an exception");
        } catch (IllegalMoveException e) {
            assertNull(null);
        }
    }
